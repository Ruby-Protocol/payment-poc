...
const rubyApp = {
  ...
  initWeb3: async function() {
    ...
    return rubyApp.initContract();
  },

  initContract: async function() {
      /* Ropsten Testnet contract addresses */
      //let rubyETHabi = (await $.getJSON('RubyETH.json')).abi;
      //rubyApp.contracts.rubyETHContract = new rubyApp.web3.eth.Contract(rubyETHabi, '0xd615f8E6e819AdBF7CC17001a4F7f838C829A5a0');
      //rubyApp.contracts.rubyETHContract.setProvider(rubyApp.web3Provider);

      /* Bsc testnet contract address */
      let rubyETHabi = (await $.getJSON('contracts/RubyETH.json')).abi;
      rubyApp.contracts.rubyETHContract = new rubyApp.web3.eth.Contract(rubyETHabi, '0xa391554CE9Dd3E504CADa7BD369Bf9d8Af59646e');
      rubyApp.contracts.rubyETHContract.setProvider(rubyApp.web3Provider);
